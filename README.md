...
| 📄 | **在线 PDF 划词** | 内置 | 打开以 .pdf 结尾的链接或 arXiv 论文，选中文字即可翻译 |
...
在 Edge 或 Chrome 中打开以 `.pdf` 结尾的链接，或 `https://arxiv.org/pdf/...` 时，文件会用内置阅读器打开。选中一段文字，点击「翻译」即可。浏览器自带的 PDF 阅读器读不到选中的文字，所以这些 PDF 会改走这个阅读器。地址栏里看不出是 PDF 的链接、以及需要登录才能下载的文件，这一版还不会自动打开。扫描版没有文字层，无法划词。
